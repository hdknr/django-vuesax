# `django-vuesax` Installation Instructions

This section contains information about 
how to download and install **django-vuesax** in your system. 
...
inside the ** django-vuesax ** distribution package. 
...
URL is https://github.org/hdknr/django-vuesax


## Install

To install **django-vuesax** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.org/hdknr/django-vuesax

The above command will install the latest development release of **django-vuesax**.
